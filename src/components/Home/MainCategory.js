              ...
              <a href="#" className="category-wrap">
                <div className="category-block">
                  <svg
                    ...
                    style={{ enableBackground: "new 0 0 469.824 469.824" }}
                    xmlSpace="preserve"
                    width="512px"
                    height="512px"
                  >
              ...
              <a href="#" className="category-wrap">
                <div className="category-block">
                  <svg
                    ...
                    style={{ enableBackground: "new 0 0 503.607 503.607" }}
                    xmlSpace="preserve"
                    width="512px"
                    height="512px"
                  >
              ...
              <a href="#" className="category-wrap">
                <div className="category-block">
                  <svg
                    ...
                    style={{ enableBackground: "new 0 0 61.168 61.168" }}
                    xmlSpace="preserve"
                    width="512px"
                    height="512px"
                  >
